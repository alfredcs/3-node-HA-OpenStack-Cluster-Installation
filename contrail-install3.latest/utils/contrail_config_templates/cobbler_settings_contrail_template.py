...
manage_forward_zones: ['contrailsystems.com', 'contrailsys.com']
manage_reverse_zones: ['10.1', '192.168']

# if using cobbler with manage_dhcp, put the IP address
# of the cobbler server here so that PXE booting guests can find it
# if you do not set this correctly, this will be manifested in TFTP open timeouts.
next_server: $__contrail_cfg_server__
...
server: $__contrail_cfg_server__
...
# Contrail stuff --BEGIN
# the path where to get the contrail packages from
# this path will be prefixed with http://server/
contrail_pkg_root: /contrail_pkgs

# this is the file which will list each of the package names that
# needs to be downloaded
contrail_pkg_list: pkg.txt

# this is the prefix that will be used for downloading a specific
# type of package Eg: <contrail_pkg_prefix>_base.tgz
# needs to be downloaded
contrail_pkg_prefix: contrail

# this is the directory on the destination machine where you want
# to put the packages into
contrail_dst_pkg_dir: /opt/contrail/pkg

# this is the webserver to add info to database. assuming this
# service is running on $server
contrail_pre_post_db_path: contrail_web/contrail/post_stat/

# this is for passing the network info to the target systems
contrail_default_router: $__contrail_cfg_gateway__
contrail_subnet_mask: $__contrail_cfg_netmask__
contrail_prefix: $__contrail_cfg_prefix__
contrail_dns1: $__contrail_cfg_dns1__
contrail_dns2: $__contrail_cfg_dns2__

# Contrail BGP Parameters
# note the format is [ifmap_port, ifmap_user, ifmap_passwd, sandesh_port]
contrail_bgp_params: ['8443', 'test3', 'test3', '8081']
